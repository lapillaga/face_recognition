...
\begin{itemize}
    \item Integrar un módulo de tracking (ByteTrack) para seguimiento temporal
    ...
    \item Optimizar para despliegue en dispositivos edge mediante TensorRT
\end{itemize}

El código fuente desarrollado queda disponible como material de referencia para futuros estudiantes interesados en sistemas de visión por computador.
